...
import language_tool_python as  language_check # new package
...
def getErrorFeatures(conllufilepath, lang):
    ...
    try:
        ...
        print("Ignoring this text: ", conllufilepath, "error:",e)
       # numerr = np.nan
       # numspellerr = np.nan
...
def getnumlist(filenameslist):
    ...
    for name in filenameslist:
        ...
        try:
            ...
            errors += 1
            result.append(3)
    print(f"number of texts without score:{errors}")
    return result
...
def train_onelang_classification(train_labels,train_data,labelascat=False, langslist=None):
    ...
    for vectorizer in vectorizers:
        for classifier in classifiers:
            ...
            print( "f1_score:",f1_score(train_labels,predicted,average='weighted'))
...
def cross_lang_testing_classification(train_labels,train_data, test_labels, test_data):
    ...
    for vectorizer in vectorizers:
        for classifier in classifiers:
            ...
            print("f1_score:",f1_score(test_labels,predicted,average='weighted'))
"""
...
def singleLangClassificationWithoutVectorizer(train_vector,train_labels): #test_vector,test_labels):
    ...
    for classifier in classifiers:
        ...
        print("f1_score:",f1_score(train_labels,predicted,average='macro'))
...
def do_mega_multilingual_model_all_features(lang1path,lang1,lang2path,lang2,lang3path,lang3,modelas, setting,labelascat):
   ...
   print(len(megalabels), len(megadata), len(megalangs))
   if len(megadata) > 0:
       print(len(megadata[0]))
...
def main():
    ...
    itdirpath = r"../Datasets/IT-Parsed"
    dedirpath = r"../Datasets/DE-Parsed"
    czdirpath = r"../Datasets/CZ-Parsed"
    '''
    print("######### SINGLE LANG #########")
    print("###### CZ ######")
    ...
    print("### domain features: ###")
    do_mega_multilingual_model_all_features(dedirpath,"de",itdirpath,"it",czdirpath,"cz","domain", "dep", True)
